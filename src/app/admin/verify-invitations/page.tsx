                ...
                {result.valid && result.card ? (
                  <div className="space-y-4">
                    <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 border border-purple-100">
                      <h4 className="font-bold text-gray-900 mb-2 text-base md:text-lg">{result.card.event?.title}</h4>
                      ...
                      <div className="flex items-center">
                        {result.card.is_used ? (
                          ...
                          <>
                            ...
                            <span className="font-medium text-green-700 text-sm md:text-base">Valid Card</span>
                          </>
                        )}
                      </div>
                    </div>
