...
export const metadata = {
  ...
  description:
    "Our storytelling program preserves Uganda's rich cultural heritage through traditional storytelling techniques, oral history, and performance.",
};
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                ...
                oral history, and performance. Children learn to appreciate and
                share the stories that form the heart of their cultural
                identity.
              </p>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg mb-6">
              TIPAC's Cultural Storytelling Program is dedicated to preserving
              and celebrating Uganda's rich storytelling traditions. In an age
              of digital media and global influences, we believe it's vital to
              connect children with their cultural heritage through the timeless
              art of storytelling.
            </p>
            <p className="text-lg mb-12">
              Our program brings together professional storytellers, cultural
              elders, and teaching artists to share traditional tales and
              techniques with a new generation. Children learn not only to
              retell these stories but to understand their cultural significance
              and to develop their own storytelling voices.
            </p>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Understanding the historical and social significance of
                        stories
                      </p>
                    </div>
                  </li>
                ...
                <ul className="space-y-3">
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Monthly weekend workshops (Last Saturday of each month,
                        9am-1pm)
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Ongoing program with annual storytelling festival in
                        December
                      </p>
                    </div>
                  </li>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div>
                  <p className="text-lg mb-4">
                    Stories are the vehicles through which cultures pass down
                    wisdom, values, and history from generation to generation.
                    In Uganda, with its rich tapestry of ethnic groups and
                    languages, storytelling has been central to cultural
                    continuity for centuries.
                  </p>
                  <p className="text-lg mb-4">
                    Our program partners with cultural elders and knowledge
                    keepers from various Ugandan communities to ensure that
                    these stories are not just preserved but shared in authentic
                    ways.
                  </p>
                  <p className="text-lg">
                    Children learn stories in both English and local languages,
                    helping to preserve linguistic diversity while making these
                    cultural treasures accessible to all.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <ol className="space-y-4">
                    <li className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Opening rituals, community building, and introducing
                          the day's theme
                        </p>
                      </div>
                    </li>
                    <li className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Learning from cultural elders sharing traditional
                          tales
                        </p>
                      </div>
                    </li>
                    <li className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Developing storytelling skills through guided
                          exercises
                        </p>
                      </div>
                    </li>
                    ...
                    <li className="flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Working in small groups to develop and practice
                          stories
                        </p>
                      </div>
                    </li>
            ...
            <div className="border border-border rounded-lg overflow-hidden mb-12">
              <div className="relative h-64">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end">
                  <div className="p-6 text-white max-w-3xl">
                    ...
                    <p>
                      A celebration of stories, tradition, and young
              ...
              <div className="p-6">
                <p className="mb-4">
                  The highlight of our Cultural Storytelling Program is the
                  annual "Voices of Uganda" festival held each December. This
                  three-day event brings together children from all our
                  storytelling groups to share the stories they've learned and
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                  <div className="border border-border rounded p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Children perform for the community, sharing stories in
                      multiple languages
                    </p>
                  </div>
                  <div className="border border-border rounded p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Open sessions where attendees can learn basic storytelling
                      techniques
                    </p>
                  </div>
                  <div className="border border-border rounded p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Recognition of elders who have contributed to preserving
                      cultural stories
                    </p>
                  </div>
                </div>
                <p className="text-primary font-medium">
                  Next Festival: December 15-17, 2025 at the TIPAC Cultural
                  Center
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <div className="bg-background p-6 rounded-lg border border-border shadow-sm">
                ...
                <p className="italic mb-6">
                  "Learning about our traditional stories has connected me to my
                  grandparents in a new way. Now when I visit my village, I can
                  understand the stories they tell and even share new ones with
                  them. It's like building a bridge between generations."
                </p>
                <div>
              ...
              <div className="bg-background p-6 rounded-lg border border-border shadow-sm">
                <div className="text-4xl text-accent mb-4">"</div>
                <p className="italic mb-6">
                  "As a cultural elder, sharing our stories with these children
                  gives me hope. They are so eager to learn, and they bring
                  fresh energy to tales I've been telling for decades. This
                  program ensures our cultural wisdom will continue."
                </p>
                <div>
            ...
            <div className="tipac-gradient p-8 rounded-lg border border-border mb-6 text-white">
              ...
              <p className="mb-6">
                Registration is open year-round, with new participants welcome
                to join at the beginning of any month.
              </p>
              <div className="space-y-4 text-white/90">
                <div className="flex gap-3">
                  ...
                  <div>
                    <strong>Complete registration form</strong> online or at our
                    center
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    <strong>Select your membership type</strong> (monthly or
                    annual)
                  </div>
                </div>
                <div className="flex gap-3">
                  ...
                  <div>
                    <strong>Attend your first workshop</strong> to begin your
