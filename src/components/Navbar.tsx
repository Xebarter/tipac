      ...
      <div className="container flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link
            href="/about"
            className={`transition-colors ${
              isLinkActive('/about') ? 'text-primary font-medium' : 'hover:text-primary'
            }`}
          >
            About Us
          </Link>
          <Link
            href="/programs"
            className={`transition-colors ${
              isLinkActive('/programs') ? 'text-primary font-medium' : 'hover:text-primary'
            }`}
          >
            Programs
          </Link>
          <Link
            href="/gallery"
            className={`transition-colors ${
              isLinkActive('/gallery') ? 'text-primary font-medium' : 'hover:text-primary'
            }`}
          >
            Gallery
          </Link>
          <Link
            href="/contact"
            className={`transition-colors ${
              isLinkActive('/contact') ? 'text-primary font-medium' : 'hover:text-primary'
            }`}
          >
            Contact
          </Link>
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full left-0 w-full bg-background shadow-md py-4 flex flex-col items-center gap-4">
            ...
            <Button className="tipac-gradient w-48" onClick={closeMobileMenu}>Donate Now</Button>
          </div>
        )}
      </div>
    </nav>
