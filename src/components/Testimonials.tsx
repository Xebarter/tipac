...
export function Testimonials() {
  const teamMembers = [
    ...
    },
    {
      ...
      bio: "Abraham oversees all TIPAC programs and workshops, ensuring they meet educational standards while remaining engaging and accessible.",
    ...
    },
    {
      ...
      image: "/team/Fred.jpg",
      bio: "Fred brings productions to life through innovative direction and choreography, specializing in blending traditional and contemporary arts.",
