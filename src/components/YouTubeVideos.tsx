        ...
        if (!response.ok) {
          ...
          switch (response.status) {
            ...
            default:
              throw new Error(
                errorData.error ||
                  `HTTP ${response.status}: Failed to fetch videos`,
              );
          }
        }
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-white/80 mb-6">
              Check back later for new performances and behind-the-scenes
              content.
            </p>
            <Link
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div
                      className={`bg-red-600 rounded-full p-4 transform transition-transform duration-300 group-hover:scale-110 shadow-lg ${
                ...
                <div className={`p-6 ${videos.length === 1 ? "lg:p-10" : ""}`}>
                  <h3
                    className={`font-bold text-gray-900 group-hover:text-red-600 transition-colors line-clamp-2 ${
                  ...
                  <p
                    className={`text-gray-600 mt-2 ${
                      videos.length === 1 ? "text-base lg:text-lg" : "text-sm"
                    }`}
                  >
