  ...
  return (
    <>
      ...
      <section
        ...
        className="w-full min-h-[40rem] relative overflow-hidden bg-slate-50 dark:bg-slate-900"
      >
        {error ? (
        ...
        <div className="absolute inset-0 flex items-center justify-center md:justify-start z-20 px-4 md:px-8">
          <div className="max-w-md bg-black/30 p-4 rounded-xl backdrop-blur-sm text-white text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start space-x-3">
              ...
              <p className="text-sm">#MDD & Poetry Festival 2025 @ National Theatre</p>
            </div>
          </div>
        </div>
      </section>
