...
-- Disable RLS on all custom tables
ALTER TABLE gallery_images DISABLE ROW LEVEL SECURITY;
ALTER TABLE events DISABLE ROW LEVEL SECURITY;
ALTER TABLE tickets DISABLE ROW LEVEL SECURITY;
ALTER TABLE contact_messages DISABLE ROW LEVEL SECURITY;

-- Disable RLS on storage tables (this should resolve your upload error)
...
DROP POLICY IF EXISTS "Allow authenticated users to manage tickets" ON tickets;
